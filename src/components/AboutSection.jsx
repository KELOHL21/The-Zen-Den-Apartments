    ...
    return ( 
        <div>
            <section className="flex flex-col p-8 sm:flex sm:justify-between sm:flex-row sm:space-x-8 lg:justify-center lg:space-x-[20em]">
                ...
                <div className="sm:max-w-[500px] lg:max-w-[920px] flex flex-col">
                    
                    <h2 className="text-[16px] text-gray-600 py-3 font-bold tracking-wide"> Welcome to Zen Den Apartments.</h2>
                    <span className="text-[13px] -mt-[0.8rem] mb-5 text-gray-600 font-semibold">Where modern living meets tranquility.</span>
