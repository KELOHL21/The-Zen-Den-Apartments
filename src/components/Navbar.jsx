    ...
    <Disclosure as="nav" className="bg-[#D2D6D9]">
      {({ open }) => (
        <>
          <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="absolute inset-y-0 right-0 items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0 hidden sm:flex">
                <button
                  type="button"
                  className="relative text-gray-600 border-2 font-medium border-gray-500 px-5 py-1 rounded-sm"
                >
                  Contact 
                </button>
              </div>
         ...
         <Disclosure.Panel className="sm:hidden flex flex-col items-center m-auto ">
            <div className="space-y-1 px-2 pb-10 pt-[8rem] items-center m-auto flex flex-col justify-center">
              ...
              <div className='pt-[7rem] md:pt-[12rem]'>
                <button
                    type="button"
                    className="relative px-9 py-2 text-gray-600 border-2 border-gray-500 rounded-sm">
                    Contact
                </button>
              </div>
